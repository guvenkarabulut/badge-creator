                                    ...
                                    <tr className="hover:bg-gray-100 focus-within:bg-gray-100">
                                      <td className="border px-4 py-2 box-border w-50">
                                        ...
                                        >
                                          {
                                            {
                                              1: `<img src="https://img.shields.io/badge/${badge.name}-${badge.color}.svg?style=${badge.style}&logo=${badge.logo}&logoColor=${badge.logoColor}&labelColor=${badge.labelColor}" alt="" />`,
                                              2: `![badge](https://img.shields.io/badge/${badge.name}-${badge.color}.svg?style=${badge.style}&logo=${badge.logo}&logoColor=${badge.logoColor}&labelColor=${badge.labelColor})`,
                                            }[htmlOrMd]
                                          }
                                        </pre>
                                      </td>
